...
- **Pricing card (RESOLVED 2026-07-26 — this supersedes the 2026-07-18 reprice):** Founding Season 2026 (unchanged): **$400 / $900 / $1,900 / $3,750** for up-to 50 / 150 / 400 / 1,000 employees, locked 3 seasons, Week-8 money-back guarantee, no card to start. **Standard rates: $750 / $1,800 / $3,900 / $7,500** — this set is live on /pricing, in the deck, and on the one-pager; charge against it. The 2026-07-18 reprice to $2,250/$5,400/$9,900 was reverted and is DEAD — purge on sight. Messaging: founding = "**about half off** the standard rate", never "more than half off" (Starter is 47% off). Substantiation: wellness-challenge comps — Count.It meters an 18-week challenge at ~$1,775 (150 emp) / ~$4,925 (400) / ~$12,485 (1,000); Terryberry ~$15.75/participant per 18 wks; Big Team Challenge ~$935–$5,800 for only 6 weeks; every new standard number sits inside the verified comp band (research 2026-07-18). Enterprise 1,000+ custom; nonprofits/schools 30% off.
