...
export default function EnrollForm({
  ...
  const card: React.CSSProperties = { width: 380, maxWidth: "100%", background: "var(--panel)", border: "1px solid var(--line)", borderRadius: 16, padding: 24 };
  const input: React.CSSProperties = { width: "100%", padding: 12, margin: "6px 0 14px", borderRadius: 10, border: "1px solid var(--line)", background: "var(--bg)", color: "var(--text)", fontSize: 16 };
  ...
  return (
    <div style={wrap}><div style={card}>
      ...
      <p style={{ color: "var(--muted)", marginTop: 4 }}>No app. Pick winners, spreads &amp; over/unders right from your phone.</p>
      {prizeText && (
      ...
      <form onSubmit={submit}>
        ...
        <p style={{ textAlign: "center", fontSize: 12.5, color: "var(--muted)", margin: "10px 0 0", lineHeight: 1.5 }}>
          ...
          <br />Same league either way — text, web, or a paper sheet in the break room.
        </p>
      </form>
    </div></div>
  );
