    ...
    body = accounts.map((a) => {
      ...
      return (
        <div className="sheet" key={a.id}><div className="insert"><div className="top">
          ...
          <p>The office football pool your <b>whole</b> team can actually play. No money. No app. Pick winners, spreads &amp; over/unders in <b>two minutes a week</b> — by text, web — or plain old paper. Shipping and the VP of Finance, same league — and shipping is winning.</p>
          ...
          <ul>
            ...
            <li><b>Everyone plays — for real.</b> Frontline crews who&apos;ll never open an app play by text or a paper sheet off the break-room stack.</li>
          </ul>
