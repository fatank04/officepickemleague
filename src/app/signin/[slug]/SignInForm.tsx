...
export default function SignInForm({ slug, leagueName }: { slug: string; leagueName: string }) {
  ...
  async function go() {
    ...
    setBusy(true); setErr("");
    const res = await fetch("/api/join", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ slug, name, pin }) });
    setBusy(false);
  ...
  return (
    <div className="wrap" style={{ maxWidth: 420 }}>
      ...
      <div className="card pad">
        ...
        <p className="muted small" style={{ marginTop: 0 }}>Enter your name and 4-digit PIN. First time? You’ll set your PIN now.</p>
