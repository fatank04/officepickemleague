...
"$FF" -y -v error \
  ...
  -filter_complex "
    ...
    color=c=black:s=520x520:d=5:r=25,format=rgba,geq=r=79:g=140:b=255:a='160*exp(-((X-260)^2+(Y-260)^2)/(2*120^2))',fade=in:st=0.4:d=0.7:alpha=1[gl];
