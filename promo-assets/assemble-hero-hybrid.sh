#!/bin/zsh
# SHIFT CHANGE hero ad — HYBRID cut: Kling for UI/brand shots (1a,3a,4a,5a), Seedance for people/atmosphere (1b,2a,3b,3c,4b).
...
"$FF" -y -v error \
  ...
  "$PA/promo-hero-shift-change-hybrid.mp4"
echo "--- done ---"; ls -la "$PA/promo-hero-shift-change-hybrid.mp4"
